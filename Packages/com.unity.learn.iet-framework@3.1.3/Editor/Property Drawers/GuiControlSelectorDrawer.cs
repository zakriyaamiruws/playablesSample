...
namespace Unity.Tutorials.Core.Editor
{
    ...
    class GuiControlSelectorDrawer : PropertyDrawer
    {
        ...
        private const string k_RectPath = "m_Rect";
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            switch ((GuiControlSelector.Mode)selectorMode.intValue)
            {
                ...
                case GuiControlSelector.Mode.VisualElement:
                    ...
                    break;
                case GuiControlSelector.Mode.Rect:
                    height += EditorGUIUtility.standardVerticalSpacing + EditorGUI.GetPropertyHeight(property.FindPropertyRelative(k_RectPath), true);
                    break;
                default:
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            switch (mode)
            {
                ...
                case GuiControlSelector.Mode.VisualElement:
                    ...
                    break;
                case GuiControlSelector.Mode.Rect:
                    selectorData = property.FindPropertyRelative(k_RectPath);
                    //position.height = EditorGUI.GetPropertyHeight(rect);
