...
namespace Unity.Tutorials.Core.Editor
{
    ...
    /// </summary>
    public class LunaPackageInstalledCriteria : Criterion
    {
        /// <summary>
        ...
        string m_PackageName = "uk.lunalabs.luna";
        ...
        private VisualElement installPackageHint;
        public static LocalizableString InstallPackageHintStr = new LocalizableString("installPackageHint");
        ...
        void CheckPackageListRequest()
        {
            ...
            if (!m_PackageIsInstalled)
            {
                installPackageHint = new Label(InstallPackageHintStr)
                {
                    style =
                    {
                        color = Color.red,
                ...
                TutorialWindow.TutorialViewInstance.tutorialScrollview.Add(installPackageHint);
            } else if ( installPackageHint?.parent != null)
            {
                installPackageHint.RemoveFromHierarchy();
            }
