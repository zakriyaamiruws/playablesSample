...
namespace Unity.Tutorials.Core.Editor
{
    internal class TutorialView : View
    {
        ...
        public const string NO_TRANSLATION_CODE = "-";
        ...
        internal VisualElement tutorialPageContainer;
        VisualElement tutorialParagraphsContainer;
        VisualElement footer;
        internal ScrollView tutorialScrollview;
        Button btnNext;
        ...
        void SetupParagraphUI(VisualElement paragraphUI, TutorialParagraph paragraph, string pageName)
        {
            ...
            switch (paragraph.Type)
            {
                case ParagraphType.Narrative:
                    ...
                    if (paragraph.Text.Translated == NO_TRANSLATION_CODE)
                    {
                        UIElementsUtils.Hide(paragraphUI.Q("TutorialStepBox1").name, paragraphUI.Q("TutorialStepBox1").parent);
                    }
                    break;
                case ParagraphType.Instruction:
                    if (string.IsNullOrEmpty(paragraph.Text) && string.IsNullOrEmpty(paragraph.Title) || 
                        ( paragraph.Text.Translated == NO_TRANSLATION_CODE && paragraph.Title.Translated == NO_TRANSLATION_CODE ) )
                    {
                    ...
                    else
                    {
                        ...
                        if (string.IsNullOrEmpty(paragraph.Title.Translated) || paragraph.Title.Translated == NO_TRANSLATION_CODE )
                        {
